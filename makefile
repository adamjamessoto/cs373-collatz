...
SphereCollatz.py: RunCollatz.py Collatz.py
	rm -f SphereCollatz.py
	cat Collatz.py RunCollatz.py > SphereCollatz.py.tmp
	grep -v '^from Collatz import collatz_solve' SphereCollatz.py.tmp > SphereCollatz.py
	pbcopy < SphereCollatz.py
	rm -f SphereCollatz.py.tmp