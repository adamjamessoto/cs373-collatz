...
from Collatz import (
    ...
    check_even_odd, acceptance_test_gen, create_meta_cache)
...
class TestCollatz (unittest.TestCase) :
    ...
    def test_solve_4 (self) :
        r = StringIO.StringIO("3135 3760\n5662 9091\n9118 159\n505 3808\n")
        w = StringIO.StringIO()
        collatz_solve(r, w)
        self.assert_(w.getvalue() == "3135 3760 238\n5662 9091 262\n9118 159 262\n505 3808 238\n")

    def test_solve_5 (self) :
        r = StringIO.StringIO("8005 9834\n1255 4674\n4397 3045\n5165 6024\n")
        w = StringIO.StringIO()
        collatz_solve(r, w)
        self.assert_(w.getvalue() == "8005 9834 260\n1255 4674 238\n4397 3045 238\n5165 6024 236\n")

    def test_solve_6 (self) :
        r = StringIO.StringIO("3959 8018\n9956 6148\n2112 7570\n5266 7378\n")
        w = StringIO.StringIO()
        collatz_solve(r, w)
        self.assert_(w.getvalue() == "3959 8018 262\n9956 6148 262\n2112 7570 262\n5266 7378 262\n")
